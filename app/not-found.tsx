      ...
      <div className="text-center max-w-2xl mx-auto px-6">
        ...
        <div className="border-t border-royal-blue/20 pt-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="https://wa.me/+5511947720129?text=Ol%C3%A1%2C+vim+pelo+seu+site+e+gostaria+de+conversar+sobre+um+projeto" className="font-body text-royal-blue hover:text-royal-blue-light hover-underline">
              Contato
            </Link>
          </div>
        </div>
