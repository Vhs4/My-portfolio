...
const experiencias = {
  pt: [
    ...
    },
    {
      ...
      empresa: "Independente / Contrato",
      periodo: "março de 2026 - Presente",
      descricao:
        "Entrega de produtos de IA para startups e clientes enterprise, com responsabilidade técnica total — da arquitetura e modelagem de dados ao deploy e suporte em produção — em colaboração com designer UX/UI.",
      conquistas: [
        "Desenvolvi SaaS que gera vídeos comerciais completos a partir de um briefing de texto, com pipeline de 12 agentes especializados orquestrados em LangGraph — grafo com estado persistente, recuperação de falhas, quality gates com agentes críticos e mecanismo self-healing que regenera artefatos sem intervenção humana",
        "Construí plataforma full-stack de prospecção B2B com enriquecimento de dados em dois estágios (Apify + agente verificador de IA), sistema ICP com segmentação gerada por IA e prospecção no LinkedIn com fila assíncrona",
        "Projetei e entreguei sozinho um LMS com IA (frontend, backend e infra) para uma professora doutora de universidade de renome no Brasil — geração de questões com GPT-4o a partir de PDFs, pipeline de detecção de lacunas de aprendizagem com diagnósticos personalizados e autenticação multi-perfil com Argon2id + pepper server-side",
        "Construí e fiz deploy da Espherinha — agente de qualificação de leads via WhatsApp para hotelaria de luxo com +70k seguidores no Instagram — e de um Concierge Interno de IA baseado em RAG, permitindo que a equipe não técnica responda hóspedes na hora",
        "Adotei desenvolvimento spec-driven e orientado a agentes: especificação primeiro, depois harness engineering (design de contexto, acesso a ferramentas e loops de verificação), com implementação delegada a agentes de código — Claude Code, Claude Cowork e Antigravity no dia a dia",
      ],
      tecnologias: [
        { nome: "LangGraph + Agno", cor: "bg-violet-600", icon: "🕸️" },
        { nome: "TypeScript + Python", cor: "bg-blue-600", icon: "🔷" },
        { nome: "Next.js + NestJS + Fastify", cor: "bg-cyan-500", icon: "⚛️" },
        { nome: "GPT-4o / Claude / Gemini", cor: "bg-emerald-600", icon: "🧠" },
        { nome: "Imagen / Veo", cor: "bg-indigo-600", icon: "🎬" },
        { nome: "BullMQ + Redis", cor: "bg-red-600", icon: "📮" },
        { nome: "Postgres + pgvector", cor: "bg-blue-700", icon: "🗄️" },
        { nome: "Supabase", cor: "bg-green-600", icon: "⚡" },
        { nome: "Docker Swarm + Traefik", cor: "bg-sky-600", icon: "🐳" },
        { nome: "RAG + WhatsApp API", cor: "bg-teal-600", icon: "🤖" },
      ],
    },
    {
  ...
  en: [
    ...
    },
    {
      ...
      empresa: "Independent / Contract",
      periodo: "March 2026 - Present",
      descricao:
        "AI product delivery for startups and enterprise clients, with full technical ownership — from architecture and data modeling to production deployment and support — in collaboration with a UX/UI designer.",
      conquistas: [
        "Developed a SaaS that generates complete commercial videos from a text briefing, with a pipeline of 12 specialized agents orchestrated in LangGraph — a graph with persistent state, failure recovery, quality gates where critic agents score each phase, and a self-healing mechanism that regenerates artifacts without human intervention",
        "Built a full-stack B2B prospecting platform with a two-stage data enrichment pipeline (Apify + AI verifier agent), an ICP system with AI-generated targeting and LinkedIn prospecting on an async queue",
        "Designed and delivered solo an AI-powered LMS (frontend, backend and infra) for a PhD professor at a renowned Brazilian university — GPT-4o question generation from PDFs, a learning-gap detection pipeline returning personalized diagnostics and multi-role auth with Argon2id + server-side pepper",
        "Built and deployed Espherinha — a WhatsApp lead-qualification agent for a luxury hospitality brand with 70k+ Instagram followers — plus a RAG-based internal AI Concierge, letting non-technical staff answer guest questions instantly",
        "Adopted spec-driven, agent-oriented development: spec first, then harness engineering (context design, tool access and verification loops), with implementation delegated to coding agents — Claude Code, Claude Cowork and Antigravity daily",
      ],
      tecnologias: [
        { nome: "LangGraph + Agno", cor: "bg-violet-600", icon: "🕸️" },
        { nome: "TypeScript + Python", cor: "bg-blue-600", icon: "🔷" },
