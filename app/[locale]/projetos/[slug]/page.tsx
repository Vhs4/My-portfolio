...
const projetosDetalhados = {
  pt: {
    "iara": {
      ...
      imagemModo: "contain",
      galeria: [],
      tecnologias: ["Inteligência Artificial", "Multi-Agentes", "TypeScript", "Node.js", "Express", "Google ADK", "Next.js", "Fastify", "PostgreSQL", "Prisma", "OpenAI", "Whisper", "Meta WhatsApp Cloud API", "Google Cloud Run", "Cloud Tasks", "Langfuse"],
    ...
    "questy": {
      ...
      tecnologias: ["Inteligência Artificial", "GPT-4o", "Next.js", "NestJS", "TypeScript", "PostgreSQL", "TypeORM", "Docker", "Traefik", "Cloudflare", "Argon2id"],
  ...
  en: {
    "iara": {
      ...
      imagemModo: "contain",
      galeria: [],
      tecnologias: ["Artificial Intelligence", "Multi-Agent Systems", "TypeScript", "Node.js", "Express", "Google ADK", "Next.js", "Fastify", "PostgreSQL", "Prisma", "OpenAI", "Whisper", "Meta WhatsApp Cloud API", "Google Cloud Run", "Cloud Tasks", "Langfuse"],
    ...
    "questy": {
      ...
      tecnologias: ["Artificial Intelligence", "GPT-4o", "Next.js", "NestJS", "TypeScript", "PostgreSQL", "TypeORM", "Docker", "Traefik", "Cloudflare", "Argon2id"],
