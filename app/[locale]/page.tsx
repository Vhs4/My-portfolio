...
import { ArrowDown, Github, Linkedin, Mail, ExternalLink, Code, Rocket, Users, Menu, X, Tent, GraduationCap, Sparkles, Bot } from "lucide-react"
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 p-6 transition-all duration-300 ${scrollY > 10 ? "backdrop-blur-md bg-pure-black/80" : "bg-transparent"}`}>
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href={locale === "en" ? "https://wa.me/+5511947720129?text=Hi%2C+I+found+your+website+and+would+like+to+discuss+a+project" : "https://wa.me/+5511947720129?text=Ol%C3%A1%2C+vim+pelo+seu+site+e+gostaria+de+conversar+sobre+um+projeto"} className="font-body hover-underline">{nav("contact")}</a>
            <LanguageSwitcher />
          </div>
      ...
      <section className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-6 md:mt-24 md:mb-24">
          ...
          <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center transition-all duration-1500 delay-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            ...
            {locale === "en" ? (
              <Button variant="outline" size="lg" className="border-royal-blue text-royal-blue hover:bg-royal-blue hover:text-pure-white font-body font-semibold px-8 py-4 text-lg transition-all duration-300 hover:scale-105 bg-transparent cursor-pointer" asChild>
        ...
        <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="grid grid-cols-1">
                <div className="relative z-10 p-8 lg:p-10">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-royal-blue/15 px-3 py-1 text-xs font-body font-semibold text-royal-blue-light">
                      <Sparkles className="h-3.5 w-3.5" />
                      {locale === "pt" ? "IA multiagente em produção" : "Multi-agent AI in production"}
                    </span>
                  </div>
                  ...
                  <span className="inline-flex items-center gap-2 font-body font-semibold text-royal-blue group-hover:text-royal-blue-light transition-colors">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-royal-blue/30 bg-gradient-to-br from-deep-gray to-pure-black transition-all duration-500 hover:border-royal-blue/60">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="relative h-64 lg:h-auto overflow-hidden order-1 lg:order-2">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-r from-pure-black/80 via-transparent to-transparent" />
                </div>
                <div className="relative z-10 p-8 lg:p-10 order-2 lg:order-1">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-royal-blue/15 px-3 py-1 text-xs font-body font-semibold text-royal-blue-light">
                      <Sparkles className="h-3.5 w-3.5" />
                      {locale === "pt" ? "Full stack + IA" : "Full stack + AI"}
                    </span>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="group relative bg-gradient-to-br from-deep-gray to-pure-black rounded-2xl p-8 border border-royal-blue/20 hover:border-royal-blue/50 transition-all duration-500 hover:scale-105">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["AWS", "NestJS", "Prisma", "MongoDB", "React Native", "Kotlin", "Back-end For Front-end", "PHP", "TypeScript"].map(t => (
                    <span key={t} className="px-3 py-1 bg-royal-blue/20 text-royal-blue-light rounded-full text-sm font-body">{t}</span>
                  ))}
                </div>
            ...
            <div className="group relative bg-gradient-to-br from-deep-gray to-pure-black rounded-2xl p-8 border border-royal-blue/20 hover:border-royal-blue/50 transition-all duration-500 hover:scale-105">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {["React", "Python", "Django"].map(t => (
                    <span key={t} className="px-3 py-1 bg-royal-blue/20 text-royal-blue-light rounded-full text-sm font-body">{t}</span>
                  ))}
                </div>
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-400">
                    <span className="text-royal-blue font-semibold">{locale === "pt" ? "Liderei" : "Led"}</span> {locale === "pt" ? "a equipe campeã regional e nominada globalmente" : "the regional champion team, globally nominated"}
                  </div>
            ...
            <div className="group relative bg-gradient-to-br from-deep-gray to-pure-black rounded-2xl p-8 border border-royal-blue/20 hover:border-royal-blue/50 transition-all duration-500 hover:scale-105">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-400">
                    <span className="text-royal-blue font-semibold">{locale === "pt" ? "+1000" : "1,000+"}</span> {locale === "pt" ? "usuários atendidos pelas IAs" : "users served by the AI agents"}
                  </div>
                  <Link href="https://espheraglamping.com.br/" className="cursor-pointer">
                    <ExternalLink className="h-5 w-5 text-royal-blue group-hover:text-royal-blue-light transition-colors" />
                  </Link>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            {[
              ...
              { value: "+4.8★", label: locale === "pt" ? "Avaliação App Mobile" : "Mobile app rating" },
      ...
      <section id="sobre" className="min-h-screen bg-pure-white text-pure-black flex items-center justify-center">
        <div className="text-center max-w-6xl mx-auto px-6 mt-8 md:mt-0">
          ...
          <p className="font-body text-xl leading-relaxed mb-8 max-w-4xl mx-auto">
            {locale === "pt"
              ? "Engenheiro Full-Stack & IA, campeão regional do NASA Space Apps Challenge e Technology and Innovation Leader no Aspire Institute (Harvard). Especialista em sistemas multi-agentes de IA e em transformar ideias inovadoras em soluções tecnológicas de impacto global."
              : "Full-Stack & AI Engineer, regional champion at NASA Space Apps Challenge and Technology and Innovation Leader at the Aspire Institute (Harvard). Specialist in multi-agent AI systems and in turning innovative ideas into globally impactful tech solutions."}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-gray-100 p-6 rounded-xl">
              ...
              <h3 className="font-heading font-bold text-xl mb-2">{locale === "pt" ? "Campeão Regional" : "Regional Champion"}</h3>
