            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                ...
                <p className="font-body text-royal-blue mb-4">
                  {locale === "pt"
                    ? "Engenheiro Full-Stack & IA, AWS Certified & Campeão Regional NASA Space Apps"
                    : "Full-Stack & AI Engineer, AWS Certified & NASA Space Apps Regional Champion"}
                </p>
                <p className="font-body text-gray-600 leading-relaxed mb-4">
                  {locale === "pt"
                    ? "Engenheiro Full-Stack & IA, campeão regional do NASA Space Apps Challenge e Technology and Innovation Leader no Aspire Institute (Harvard). Apaixonado por compartilhar conhecimento e ajudar outros desenvolvedores a evoluir em suas carreiras."
                    : "Full-Stack & AI Engineer, regional champion at NASA Space Apps Challenge, and Technology and Innovation Leader at the Aspire Institute (Harvard). Passionate about sharing knowledge and helping developers grow in their careers."}
                </p>
